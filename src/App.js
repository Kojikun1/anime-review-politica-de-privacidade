...
function App() {
  return (
    <div className="App">
      ...
      <p>Se após você nos fornecer seus dados, você mudar de ideia, você pode retirar o seu consentimento para que possamos entrar em contato, para a coleção de dados contínua, uso ou divulgação de suas informações, a qualquer momento, entrando em contato conosco reviewanimeapp@gmail.com em anime ou nos enviando uma correspondência em: Nippon software Caldas Novas Goias Brazil</p>
